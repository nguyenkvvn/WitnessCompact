# PolyWitnessCompact
Printable frame for compact variant of the Witness pistols

# Author
by nguyenkvvn
original file by FreeMenDontAskPermission (FreeMenDontAsk)

# Version
1.0

## Description 
A compact variant of Freeman's EAA SAR P2K Frame for 9mm parts kits in compact length, with compact magazines. It includes a spacer for a full-size magazine.
...
> Imported from Freeman's original file
